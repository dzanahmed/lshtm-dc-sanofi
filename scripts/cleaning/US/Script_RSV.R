...
db_rsv <- read_csv("data/raw_data/US/Weekly_Rates_of_Laboratory-Confirmed_RSV_Hospitalizations_from_the_RSV-NET_Surveillance_System.csv"
     )
...
unique(db_rsv_age$`Age Category`) # Preview age groups
...
write_csv(db_rsv_age, 'data/processed_data/US/US_CDC_RSV_age.csv')

write_csv(db_rsv_overall, 'data/processed_data/US/US_CDC_RSV_overall.csv')