...
hsp_rates_flu_covid_22_23_all_ages <- read_ods('data/raw_data/UK/Weekly_Influenza_and_COVID19_report_data_w2_report.ods',
                 sheet = 31)
...
hsp_rates_flu_covid_22_23_all_ages <- hsp_rates_flu_covid_22_23_all_ages %>% mutate(year = 
                                                  case_when(week >= 2 ~ 2022,
                                                            week < 2 ~ 2023))

write_csv(hsp_rates_flu_covid_22_23_all_ages,'data/processed_data/UK/hsp_rates_cov_flu_2223.csv')

### FLU DATA ###
hsp_rates_flu <- read_ods('data/raw_data/UK/Weekly_Influenza_and_COVID19_report_data_w2_report.ods',
                                               sheet = 32)
...
write.csv(hsp_rates_flu,'data/processed_data/UK/flu_rates_all_ages.csv')

#rsv data 2017-2023
rsv <- read_ods('data/raw_data/UK/Weekly_Influenza_and_COVID19_report_data_w2_report.ods',
                                               sheet = 40)
...
write_csv(rsv,'data/processed_data/UK/rsv_all_yrs_all_ages.csv')
