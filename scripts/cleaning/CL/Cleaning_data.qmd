...
This code was meant for fix and the population error (just the last year)
```{r}
...
This code takes FR data form processed_data folder (those don't have all the needed columns). This code provides the missing columns
